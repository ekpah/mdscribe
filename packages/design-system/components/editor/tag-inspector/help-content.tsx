	...
	<div className="space-y-4">
		...
		<div className="space-y-2">
			...
			<p className="text-muted-foreground text-sm">
				Nutzen Sie Tags und KI-Hinweise für dynamische Templates. Klicken Sie auf ein Tag im
				Editor, um seine Eigenschaften hier zu bearbeiten.
			</p>
		</div>
		...
		<div className="space-y-2">
			...
			<ul className="space-y-1.5 text-muted-foreground text-xs">
				<li className="flex items-start gap-2">
					...
					<span>
						Verwenden Sie{" "}
						<kbd className="rounded bg-muted px-1 py-0.5 font-mono text-xs">/</kbd> für
						Schnellbefehle
					</span>
				</li>
				<li className="flex items-start gap-2">
				...
				<li className="flex items-start gap-2">
					<span className="text-solarized-cyan">•</span>
					<span>Nutzen Sie &quot;Quelltext anzeigen&quot; um den Markdoc-Code direkt zu sehen</span>
				</li>
			</ul>
		</div>
	</div>

					...
					<Section className="mt-8 rounded-md bg-muted p-px">
						<Section className="rounded-[5px] bg-card p-8">
							...
							<Text className="text-muted-foreground">
								du kannst jetzt für freigeschaltete KI-Verbindungen deinen eigenen API-Schlüssel
								hinterlegen. Protokoll, Zieladresse und Modelle bleiben dabei sicher durch den
								Administrator vorgegeben.
							</Text>
							<Text className="text-muted-foreground">
								Aufrufe über deinen Schlüssel verbrauchen keine MDScribe-Quota. Kosten, Guthaben und
								Limits des jeweiligen KI-Anbieters gelten weiterhin für dein Provider-Konto.
							</Text>
							<Section className="mt-6 rounded-md border border-border bg-background p-4">
								...
								<Text className="text-muted-foreground">
									Der Schlüssel wird verschlüsselt gespeichert und nach dem Speichern nicht wieder
									angezeigt. Du kannst ihn jederzeit deaktivieren, ersetzen oder vollständig
									löschen.
								</Text>
								<Button

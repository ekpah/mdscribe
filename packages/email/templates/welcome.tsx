						...
						<Section className="mt-8 rounded-md bg-muted p-px">
							<Section className="rounded-[5px] bg-card p-8">
								...
								<Text className="text-muted-foreground">
									wir freuen uns sehr, Dich bei uns begrüßen zu dürfen! Dein Konto wurde erfolgreich
									erstellt und verifiziert.
								</Text>
								<Text className="text-muted-foreground">
									Du kannst jetzt alle Funktionen unserer Plattform nutzen. Bei Fragen stehen wir

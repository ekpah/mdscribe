            ...
            <Section className="mt-8 rounded-md bg-muted p-px">
              <Section className="rounded-[5px] bg-card p-8">
                ...
                <Text className="text-muted-foreground">
                  wir arbeiten gerade an einem neuen Dokumente-Bereich in
                  MDScribe. Ein typischer Anwendungsfall: Rehaanträge für die
                  Deutsche Rentenversicherung vorbereiten, inklusive Anlage und
                  ärztlichem Befundbericht.
                </Text>
                <Text className="text-muted-foreground">
                  Statt Angaben aus Gespräch, Anamnese und Befund manuell in
                  PDF-Felder zu übertragen, sollst Du relevante Informationen
                  diktieren oder einfügen können. MDScribe strukturiert daraus
                  einen Vorschlag für Formularfelder, Begründung und
                  Befundbericht.
                </Text>
                  ...
                  <Row>
                    <Column className="w-[33%] pr-2 align-top">
                      <Section className="rounded-md bg-muted p-3">
                        ...
                        <Text className="mb-0 text-muted-foreground text-xs">
                          Medizinische Reha ist ein wiederkehrender Fall im
                          Praxisalltag.
                        </Text>
                      </Section>
                    </Column>
                    <Column className="w-[33%] px-1 align-top">
                      <Section className="rounded-md bg-muted p-3">
                        ...
                        <Text className="mb-0 text-muted-foreground text-xs">
                          Antrag, Anlage und Befundbericht folgen klaren
                          Formularlogiken.
                        </Text>
                      </Section>
                    </Column>
                    <Column className="w-[33%] pl-2 align-top">
                      <Section className="rounded-md bg-muted p-3">
                        ...
                        <Text className="mb-0 text-muted-foreground text-xs">
                          Indikation, Verlauf und Ziele lassen sich natürlich
                          ärztlich formulieren.
                        </Text>
                      </Section>
                    </Column>
                  </Row>
                ...
                <Text className="text-muted-foreground">
                  Die Funktion befindet sich noch in Entwicklung. Du kannst den
                  neuen Bereich aber bereits öffnen und uns früh Feedback geben,
                  welche Reha- und Formularprozesse in Deinem Alltag am meisten
                  Zeit kosten.
                </Text>
                <Hr className="my-4" />
                <Button

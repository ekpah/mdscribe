						...
						<Section className="mt-8 rounded-md bg-muted p-px">
							<Section className="rounded-[5px] bg-card p-8">
								...
								<Text className="text-muted-foreground">
									Du verbringst wahrscheinlich 3-4 Stunden täglich mit Dokumentation. Was wäre, wenn
									du diese Zeit für deine Patienten nutzen könntest?
								</Text>
								<Text className="text-muted-foreground">
									<strong>MDScribe</strong> ist die KI-Lösung für Assistenzärzte, um ihre
									Dokumentation zu revolutionieren.
								</Text>
								<Text className="font-bold text-lg text-muted-foreground">Was du bekommst:</Text>
								<Text className="text-muted-foreground">
									⚡ <strong>70% Zeitersparnis</strong> bei Arztbriefen & Berichten
								</Text>
								<Text className="text-muted-foreground">
									📋 <strong>Intelligente Vorlagen</strong> für alle Fachbereiche
								</Text>
								<Text className="text-muted-foreground">
									🤖 <strong>KI-generierte Entlassbriefe</strong> automatisch aus Befunden erstellt
								</Text>
								<Text className="text-muted-foreground">
									<strong>Kostenlos testen</strong> - keine Kreditkarte erforderlich. Starte noch
									heute!
								</Text>
								<Hr className="my-4" />
								<Button

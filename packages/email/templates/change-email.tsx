...
export const EmailChangeTemplate = ({ url, newEmail }: EmailChangeTemplateProps) => (
					...
					<Section className="mt-8 rounded-md bg-muted p-px">
						<Section className="rounded-[5px] bg-card p-8">
							...
							<Text className="m-0 text-muted-foreground">
								Es wurde eine E-Mail-Änderung auf die Adresse {newEmail} angefragt. Klicke auf den
								Button unten, um die Änderung der E-Mail-Adresse zu genehmigen.
							</Text>
							<Hr className="my-4" />
							<Button
								href={url}

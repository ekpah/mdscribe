...
1. **Datenschutzrechtlich:** Personenbezogene Gesundheitsdaten unterliegen einem besonderen Schutz. MDScribe soll möglich weit und kostenlos verfügbar sein, um die Dokumentation auch für einzelne AssitentInnen zu erleichtern. Wenn keine Einbindung in die Krankenhaus-IT vorliegt, ist es jedoch notwenig, Daten nach außen zu übertragen, was nur bei anonymisierten Daten erlaubt ist.
2. **Haftung:** Die Verantwortung für die Einhaltung dieser Vorgaben liegt beim Nutzer. Ein Verstoß kann zur Sperrung des Accounts - unter Umständen aber auch zu deutlich weitreichenderen Konsequenzen führen. Achtet deshalb unbeding sorgfältig darauf, dass nur anonymisierte Daten eingegeben werden.

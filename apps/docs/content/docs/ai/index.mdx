...
AI Textbausteine verwenden kein eigenes Modell mehr, sondern immer die globalen Standardmodelle.

Aktivierte globale und oeffentliche nutzererstellte Eintraege erscheinen automatisch auf `/aiscribe` im Bereich `AI Textbausteine`. Aktivierte eigene Eintraege erscheinen fuer den jeweiligen Nutzer direkt unter den Standardmodi im Bereich `Meine AI Textbausteine`. Private AI Textbausteine sind eine Plus-Funktion und bleiben nur fuer den Autor sichtbar und nutzbar.

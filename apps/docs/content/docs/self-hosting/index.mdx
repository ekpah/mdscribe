...
Wenn Sie MDScribe per Dockerfile deployen, fuehrt das Produktions-Image diese Migrationen beim Container-Start automatisch aus und startet danach erst die App.
...
- [ ] `bun run db:migrate` erfolgreich gegen die Ziel-Datenbank ausgeführt

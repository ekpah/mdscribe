...
| `type` | String | Nein | `"string"` | Datentyp: `"string"`, `"number"`, `"date"` |
| `unit` | String | Nein | - | Einheit für den Wert (z.B. "kg", "mmHg") |
| `round` | Number oder `false` | Nein | - | Rundet Zahlen auf die angegebene Anzahl Nachkommastellen; `false` lässt den Wert ungerundet |
...
**Zahl auf eine Nachkommastelle runden:**
```markdown
**Temperatur**: {% info "Temperatur" type="number" unit="°C" round=1 renderUnit=true /%}
```

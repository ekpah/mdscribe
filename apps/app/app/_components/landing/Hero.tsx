...
export default function Hero() {
  ...
  return (
    <div className="relative flex h-auto min-h-[90vh] flex-col items-center bg-gradient-to-b from-background to-muted/30 md:px-3 md:h-[90vh] md:flex-row md:flex-wrap">
      {/*<!--Left Col-->*/}

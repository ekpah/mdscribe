...
const DEFAULT_MODEL_ROWS: Array<{
	...
	{
		description:
			"Erzeugt die finale Antwort, wenn kein multi-modales Standardmodell gesetzt ist.",
			...
			<Card className="border-solarized-base2 bg-gradient-to-br from-solarized-base3 to-solarized-base2/50">
							...
							>
								...
								<div className="space-y-2">
									<ReasoningEffortSelect
										...
										value={
											supportsReasoning
												? getDefaultReasoningEffort(row.type)
												: "none"
										}
									/>
									{selectedModel && !supportsReasoning ? (
										<p className="text-solarized-base01 text-xs">
											Dieses Modell meldet keine Reasoning-Unterstützung. MDScribe
											sendet deshalb keine Reasoning-Optionen.
										</p>
									) : null}
								</div>
							</div>
				...
				<CardContent className="px-4 pb-4 pt-0 sm:px-6 sm:pb-6 sm:pt-0">
					<div className="rounded-md border border-solarized-base2/80 bg-solarized-base2/20 p-3 text-solarized-base01 text-xs">
						...
						<div>OCR/File/Image: Modell muss Datei- oder Bild-Eingaben (z.B. PDF/OCR) in Text überführen.</div>

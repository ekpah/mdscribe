				...
				<div className="mb-10 space-y-5 text-center sm:mb-16 sm:space-y-6">
					...
					<div className="space-y-3 sm:space-y-4">
						<h1 className="px-2 font-bold text-3xl text-foreground leading-tight sm:text-4xl lg:text-5xl">
							Willkommen bei <span className="text-solarized-blue">MDScribe</span>!
						</h1>
						<p className="mx-auto max-w-2xl px-4 text-lg text-muted-foreground sm:px-0 sm:text-xl">
							Deine E-Mail wurde erfolgreich verifiziert. Du kannst jetzt alle Funktionen nutzen, um
							deine medizinische Dokumentation zu revolutionieren.
						</p>
					</div>
					...
					<div className="px-4 pt-4 sm:px-0">
						<Button
							...
							size="lg"
							render={
								<Link className="flex items-center justify-center gap-2 sm:gap-3" href="/aiscribe">
						...
						<p className="mt-3 px-2 text-muted-foreground text-sm sm:px-0">
							Erstelle in Sekunden professionelle Arztbriefe mit KI-Unterstützung
						</p>
					</div>
				</div>
				...
				<div className="space-y-8 sm:space-y-12">
						...
						>
							<Card className="h-full border-solarized-red/30 bg-solarized-red/5 transition-colors hover:border-solarized-red/50">
								<CardHeader className="text-center">
									...
									<CardTitle className="text-solarized-red">Notfall-Modus</CardTitle>
									<CardDescription>
										Erstelle Anamnesen und Diagnosen für Notaufnahme-Patienten
									</CardDescription>
								</CardHeader>
							</Card>
						</Link>
						...
						>
							<Card className="h-full border-solarized-blue/30 bg-solarized-blue/5 transition-colors hover:border-solarized-blue/50">
								<CardHeader className="text-center">
									...
									<CardTitle className="text-solarized-blue">Ambulant-Modus</CardTitle>
									<CardDescription>
						...
						>
							<Card className="h-full border-solarized-green/30 bg-solarized-green/5 transition-colors hover:border-solarized-green/50">
								<CardHeader className="text-center">
									...
									<CardTitle className="text-solarized-green">Entlassung-Modus</CardTitle>
									<CardDescription>
						...
						>
							<Card className="h-full border-solarized-orange/30 bg-solarized-orange/5 transition-colors hover:border-solarized-orange/50">
								<CardHeader className="text-center">
									...
									<CardTitle className="text-solarized-orange">Prozedur-Modus</CardTitle>
									<CardDescription>
									...
									<CardHeader>
										<div className="flex items-center gap-3">
											...
											<div>
												...
												<CardDescription>
													Entdecke hunderte von vorgefertigten medizinischen Vorlagen
												</CardDescription>
											</div>
										</div>
									</CardHeader>
									...
									<CardHeader>
										<div className="flex items-center gap-3">
											...
											<div>
												...
												<CardDescription>
													Erstelle personalisierte Textbausteine für deine Praxis
												</CardDescription>
											</div>
										</div>
									</CardHeader>
					...
					<div className="mx-2 space-y-4 rounded-2xl bg-gradient-to-r from-solarized-blue/10 to-solarized-green/10 p-4 text-center sm:mx-0 sm:p-8">
						...
						<p className="mx-auto max-w-2xl px-2 text-base text-muted-foreground sm:px-0 sm:text-lg">
							Starte mit einem der KI-Modi und erlebe, wie schnell und präzise medizinische
							Dokumentation sein kann.
						</p>
						<div className="flex flex-col items-center justify-center gap-3 px-2 pt-4 sm:flex-row sm:gap-4 sm:px-0">
							<Button
								...
								size="lg"
								render={
									<Link className="flex items-center justify-center gap-2" href="/aiscribe">
							...
							<Button
								...
								variant="outline"
								render={
									<Link className="flex items-center justify-center gap-2" href="/templates">

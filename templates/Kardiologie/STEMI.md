...
Die notfallmäßige Aufnahme von {% switch "gender" %}
{% case "undefined" %}[#Herrn/Frau#]{%/case%}
{% case "male" %}Herrn{%/case%}
{% case "female" %}Frau{%/case%}
{%/switch%}{% info "name" /%} erfolgte nach primärer Vorstellung mit einem ST-Hebungsinfarkt der [#Vorderwand/Hinterwand#] direkt in unser Herzkatheterlabor.
...
Die duale Thrombozytenaggregationshemmung mit ASS 100 mg (1-0-0) und Brilique 90 mg (1-0-1) sollte für 1 Jahr fortgeführt werden. Danach kann Brilique abgesetzt werden. ASS sollte lebenslang weiter eingenommen werden.
Die übrige medikamentöse Sekundärprophylaxe nach Myokardinfarkt wurde begonnen.

Nach 48-stündiger Überwachung konnte der Patient auf unsere kardiologische Schwerpunktstation verlegt werden.
In den anschließend durchgeführten LZ-EKG und TTE-Untersuchugen zeigten sich keine höhergradigen bradykarden oder tachykarden Herzrhythmusstörungen und eine [#kompensierte linksventrikuläre Funktion#].

...
**Name der Neoplasie, ED XX/XX**
    ...
    Initiales Stadium: Tx Nx Mx, Gx, (ggf. LX VX CRMX, Ann Arbor, Binet), UICC Stadium 	XXX
      	...
      	Histologie: XXX (pathologisches Institut von XXX, E-Nummer XX)
      	ggf. spezifische Parameter (z.B. Mikrosatellitenstatus)
       	ggf. Molekulargenetik
     	Tumormarker initial: XX, XX, XX
      	ECOG bei Diagnose: XX, Karnofsky-Index: XX
       	Größe: XX, Gewicht (initial): XX
    Khoranascore (Thromboembolierisiko): x (xxx Risiko)
